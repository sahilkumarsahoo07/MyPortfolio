...
import image1 from '../image/Skills/React.jpg';
import image2 from '../image/Skills/HTML CSS.jpg';
import image3 from '../image/Skills/Java Script.jpg';
import image4 from '../image/Skills/Jquery.jpg';

const MySkills = () => {
  const [focusElement, setFocusElement] = useState(0);

  const images = [image1, image2, image3, image4];
  const info = ['React', 'HTML CSS', 'Java Script', 'JQuery'];
  return (
    <>
      <div className="p-5">
          ...
          <div className="col-md-6 d-flex justify-content-center align-items-center">
            <div class="parent">
              <div class="card">
                ...
                <div class="glass"></div>
                <div class="content">
                  <span class="title">{info[focusElement]}</span>
